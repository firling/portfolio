...
import AnimatedText from '@/components/animated/Title'
  ...
  return (
    <>
      <Hero>
        ...
        <h1 className="text-4xl uppercase font-bold tracking-tight sm:text-6xl">
          <small><AnimatedText text="Salut, je suis" /></small> 
          <AnimatedText text=" Julien Anquetil" />
        </h1>
